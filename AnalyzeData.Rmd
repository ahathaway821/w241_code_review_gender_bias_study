...
d_raw[,employment:=relevel(as.factor(employment), "Unemployed / Student")]s
```
...
numeric_responses = c('code_quality', 'num_bugs', 'num_quality', 'num_texts', 'percent_bugs', 'percent_quality', 'Duration (in seconds)')
...
# Results by Gender
```{r}
hist(d[gender_shown=="Female", num_lines], col=rgb(0,0,1,0.10), xlim=c(0,20), ylim=c(0,10), breaks=20, main="Histogram of Number of Comments by Gender Shown", xlab="Number of Comments")
hist(d[gender_shown=="Male", num_lines], col=rgb(1,0,0,0.10), xlim=c(0,20), ylim=c(0,10), breaks=20, add=T)
legend(x=14, y=8, legend=c("Female Treatment", "Male Treatment"),
...
```{r}
lm = d[,lm(num_lines ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)['gender_shownFemale',]
```

### Interaction Effects
```{r}
lm = d[,lm(num_lines ~ gender_shown + gender_shown*gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:genderFemale'),]
```

```{r}
lm = d[,lm(num_lines ~ gender_shown + gender + age + gender_shown*years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
...
```{r}
lm = d[,lm(num_lines ~ gender_shown + gender + age + gender_shown*years_javascript + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
...
```{r}
lm = d[,lm(num_lines ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + gender_shown*employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:employmentEmployed by:'),]
```

```{r}
lm = d[,lm(num_lines ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + gender_shown*pct_men)]
...
```{r}
lm = d[,lm(code_quality ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)['gender_shownFemale',]
```

### Interaction Effects
```{r}
lm = d[,lm(code_quality ~ gender_shown + gender_shown*gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:genderFemale'),]
```

```{r}
lm = d[,lm(code_quality ~ gender_shown + gender + age + gender_shown*years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:years_programming3-5 years',
                        'gender_shownFemale:years_programming5-10 years', 'gender_shownFemale:years_programming10-15 years'),]
```

```{r}
lm = d[,lm(code_quality ~ gender_shown + gender + age + gender_shown*years_javascript + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:years_javascript1-2 years',
                        'gender_shownFemale:years_javascript3-5 years',
                        'gender_shownFemale:years_javascript5-10 years', 
                        'gender_shownFemale:years_javascript10-15 years'),]
...
```{r}
lm = d[,lm(code_quality ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + gender_shown*pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:pct_men'),]
```

```{r}
lm = d[,lm(code_quality ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + gender_shown*ratio_men_to_women)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:ratio_men_to_women'),]
```

```{r}
lm = d[,lm(code_quality ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + gender_shown*log(ratio_men_to_women))]
...
```{r}
lm = d[,lm(percent_bugs ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)['gender_shownFemale',]
```

### Interaction Effects
```{r}
lm = d[,lm(percent_bugs ~ gender_shown + gender_shown*gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:genderFemale'),]
```

```{r}
lm = d[,lm(percent_bugs ~ gender_shown + gender + age + gender_shown*years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:years_programming3-5 years',
                        'gender_shownFemale:years_programming5-10 years', 'gender_shownFemale:years_programming10-15 years'),]
```

```{r}
lm = d[,lm(percent_bugs ~ gender_shown + gender + age + gender_shown*years_javascript + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:years_javascript1-2 years',
                        'gender_shownFemale:years_javascript3-5 years',
                        'gender_shownFemale:years_javascript5-10 years', 
                        'gender_shownFemale:years_javascript10-15 years'),]
...
```{r}
lm = d[,lm(percent_bugs ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + gender_shown*employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:employmentEmployed by:'),]
```

```{r}
lm = d[,lm(percent_bugs ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + gender_shown*pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:pct_men'),]
```
...
```{r}
lm = d[,lm(`Duration (in seconds)` ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)['gender_shownFemale',]
```

### Interaction Effects
```{r}
lm = d[,lm(`Duration (in seconds)` ~ gender_shown + gender_shown*gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:genderFemale'),]
```

```{r}
lm = d[,lm(`Duration (in seconds)` ~ gender_shown + gender + age + gender_shown*years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:years_programming3-5 years',
                        'gender_shownFemale:years_programming5-10 years', 'gender_shownFemale:years_programming10-15 years'),]
```

```{r}
lm = d[,lm(`Duration (in seconds)` ~ gender_shown + gender + age + gender_shown*years_javascript + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:years_javascript1-2 years',
                        'gender_shownFemale:years_javascript3-5 years',
                        'gender_shownFemale:years_javascript5-10 years', 
                        'gender_shownFemale:years_javascript10-15 years'),]
...
```{r}
lm = d[,lm(`Duration (in seconds)` ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + gender_shown*employment + pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:employmentEmployed by:'),]
```

```{r}
lm = d[,lm(`Duration (in seconds)` ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + gender_shown*pct_men)]
getRobustCoefTest(lm)[c('gender_shownFemale', 'gender_shownFemale:pct_men'),]
```

## Are certain people more likely to remember gender?
```{r}
lm = d[,lm(correct_gender ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)
```

## Are certain people more likely to remember name?
```{r}
lm = d[,lm(correct_name ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)
```

## Placebo: are certain people more likely to remember app name?
```{r}
lm = d[,lm(correct_app ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)
```

## Placebo: are certain people more likely to remember company name?
```{r}
lm = d[,lm(correct_company ~ gender_shown + gender + age + years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
getRobustCoefTest(lm)
```
