...
get_se_robust <- function(model) { 
  ## takes a model and computes the robust standard error
  require(sandwich, quietly = TRUE)
  
  ses <- sqrt(diag(vcovHC(model)))
...
```{r}
lm = d[,lm(num_lines ~ gender_shown + is_reviewer_female + age + gender_shown*years_programming + years_javascript + num_crs_per_week + education + employment + pct_men)]
